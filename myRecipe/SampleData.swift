...
struct SampleDate {
    static let recipes = [
        Recipe(name: "Spaghetti Bolognese",
              ingredients: ["Spaghetti", "Ground beef", "Onion", "Garlic", "Tomato sauce", "Oregano", "Salt", "Pepper"],
              instructions: "Cook the spaghetti according to the package instructions. In a large skillet, brown the ground beef with the onion and garlic. Add the tomato sauce, oregano, salt, and pepper. Stir to combine. Serve the spaghetti Bolognese hot.",
              servings: 4,
              perTime: "10 minutes",
              cookTime: "20 minutes",
              imageName: "spaghetti-bolognese"),
        Recipe(name: "Chicken Curry",
               ingredients: ["Chicken Breast", "Curry Poweder", "Coconut Milk", "Onion", "Garlic", "Ginger"],
              instructions: "Cook the chicken brewast with onion, gralic, and ginger. Add curry powder and coconut milk. Simmer until chicken is cooked through.",
              servings: 4,
              perTime: "15 min",
              cookTime: "25 min",
              imageName: "chicken-curry"),
        Recipe(name: "Beeff Stroganoff",
        ...
        Recipe(name: "Fish Tacos",
              ingredients: ["Fish Fillets", "Tortillas", "Cabbage", "Lime", "Cilantro", "Sour Cream"],
               instructions: "Cook fish fillets and break into pieces. Assemble tacos with tort illas, fish, cabbage, lime, cilantro, and sour cream.",
              servings: 4,
              perTime: "10 min",
              cookTime: "10 min",
